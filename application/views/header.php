...
<body class='body-bg'>
    ...
    <nav class="header-nav navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
				...
				<!--LOGO--->
                <a class="navbar-brand" href="<?php echo base_url();?>">Growth Care Uganda - Job Portal</small></a>
            </div>
            <div class="collapse navbar-collapse header_menu container_head_menu" id="bs-example-navbar-collapse-1" >
                <ul class="nav navbar-nav ">
					...
					<?php } else { ?>
					<!-- <li class="header_list <?php if($tab=='MANAGE')  { ?>active <?php } ?>"><a href="<?php echo base_url();?>managejobs" class="menu_item" id="about">JOBS MANAGE</a></li> -->
